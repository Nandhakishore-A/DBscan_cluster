...
# --------------------------------------------------
# BASE DIRECTORY (LOCAL + CLOUD SAFE)
# --------------------------------------------------
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# --------------------------------------------------
# LOAD DATA & TRAINED FILES (SAFE PATHS)
# --------------------------------------------------
def load_assets():
    ...
    data_path = os.path.join(BASE_DIR, "DATA_SETS", "wine_clustering_data.csv")
